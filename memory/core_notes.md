...
**Version**: v1.16 (ESM integration + Web Definitions)
...
- Other: \( \beta_{g_N}=2g_N+B_1 g_N^2+O(g_N^3) \), \( \beta_\Lambda\approx C_0\mu_\ell^4+C_2\mu_\ell^2\Lambda+C_4\Lambda^2 \),
