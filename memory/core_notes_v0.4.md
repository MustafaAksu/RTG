# Relational Time Geometry (RTG) – Core Notes v0.4
...
- id: photon_mass_relation
  type: open_question
  value: "Photon effective mass arises in bounded resonance clusters; free-state photons remain effectively massless."
